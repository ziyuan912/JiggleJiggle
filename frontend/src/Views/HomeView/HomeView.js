    ...
    <div className='wrapper'>
      ...
      <div className="container-fluid">
        <div className="row" style={{ height: "100vh" }}>
          <div className="col col-lg-2">
            <div className="row" style={{height: "100%"}}>
              <div className="col-12" id="topmenu" style={{height: "65%", padding: "1vh 2vw"}}>

                <button type="button" className="btn btn-elegant px-3" style={{display: '-webkit-box'}}><FontAwesomeIcon icon={ faHouse } style={{color: "#000000"}}/> Dashboard</button>
                <button type="button" className="btn btn-elegant px-3" style={{display: '-webkit-box'}}><FontAwesomeIcon icon={ faWindowMaximize } style={{color: "#000000"}}/> My Courses</button>
                <button type="button" className="btn btn-elegant px-3" style={{display: '-webkit-box'}}><FontAwesomeIcon icon={ faChartSimple } style={{color: "#000000"}}/> Analytics</button>

            </div>
            <div className="col-12" id="bottommenu" style={{padding: "1vh 2vw"}}>
              <button type="button" className="btn btn-elegant px-3" style={{display: '-webkit-box'}}><FontAwesomeIcon icon={ faCircleInfo } style={{color: "#000000"}}/> Help</button>
              <button type="button" className="btn btn-elegant px-3" style={{display: '-webkit-box'}}><FontAwesomeIcon icon={ faUser } style={{color: "#000000"}}/> Accounts</button>
            </div>
          </div>
        </div>
        ...
        <div className="col col-lg-10">
          ...
          <h3 className='mt-2'>Inspirations</h3>
          <div className="row">
            <div className="col">
              <a href='dance'><img id="Voguing" src="https://static.wixstatic.com/media/1648f7_0834ed45601747e68b8fdfb9601aa0f7~mv2.png/v1/fill/w_1200,h_670,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/1648f7_0834ed45601747e68b8fdfb9601aa0f7~mv2.png"/></a>
                <div className="row">
                  ...
                  <div className="col col-lg-11" style={{paddingLeft: "30px"}}>
